...
def aplicar_estilo():
    ...
    /* =========================================================
       PROVICHECK - SOBRESCRITURA FINAL DE CONTROLES STREAMLIT
       ========================================================= */
    ...
    div[data-testid="stSelectbox"] svg {
        color: #0F2747 !important;
        fill: #0F2747 !important;
        -webkit-text-fill-color: #0F2747 !important;
    }

    /* Fecha, hora, texto y números */
    ...
    div[data-testid="stExpander"] summary {
        ...
        background-color: #147A3B !important;
    ...
    .pc-accreditation-box {
        margin: .35rem 0 .85rem;
        padding: .8rem 1rem;
        border: 1px solid #BFD0E5;
        border-left: 5px solid #147A3B;
        border-radius: 10px;
        background: linear-gradient(90deg,#F4FBF7,#F4F8FF);
    }

    .pc-accreditation-box strong {
        color: #0F2747 !important;
    }

    .pc-accreditation-box span {
